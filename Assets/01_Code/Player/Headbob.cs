...
public class Headbob : MonoBehaviour
{
    ...
    private Vector3 StartHeadbob(float multiplier)
    {
        ...
        pos.y = Mathf.Lerp(0f, Mathf.Sin(Time.time * headBobFrequency) * headBobAmount * multiplier * 1.5f, headBobSmooth * Time.deltaTime);
        pos.x = Mathf.Lerp(0f, Mathf.Cos(Time.time * headBobFrequency / 2f) * headBobAmount * multiplier * 1.6f, headBobSmooth * Time.deltaTime);
